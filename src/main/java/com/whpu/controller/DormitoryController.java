...
public class DormitoryController {
	...
	public String findDormitoryStudent(Dormitory dormitory, Model model, Integer pageIndex, Integer pageSize) {
		PageInfo<Dormitory> d = dormitoryService.findDormitoryStudent(dormitory,pageIndex,pageSize);
		model.addAttribute("ci",d);
		model.addAttribute("ds",d.getList());
