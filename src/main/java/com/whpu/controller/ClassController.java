...
public class ClassController {
	...
	public String findClassStudent(Class uclass, Model model,Integer pageIndex, Integer pageSize) {
		PageInfo<Class> ci = classService.findClassStudent(uclass,pageIndex,pageSize);
		List<Class> list = ci.getList();
