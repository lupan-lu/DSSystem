...
public interface DormitoryDao {
	...
	public List<Dormitory> findDormitoryStudent(@Param("dormitory") Dormitory dormitory, @Param("currentPage") Integer pageIndex, @Param("pageSize") Integer pageSize);//查询宿舍人员信息
	public Integer findDormitoryStudentTotal(@Param("dormitory") Dormitory dormitory);
